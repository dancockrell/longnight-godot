...
const ALL := [
	# ---------------------------------------------------------- CURRENT --
	{"id":"anchor_current","name":"Bulwark","pillar":CURRENT,"origin_year":1944,"role":"anchor",
	...
	{"id":"conduit","name":"Arcwright","pillar":CURRENT,"origin_year":1944,"role":"quartermaster",
	 "hp":130,"focus":85,"atk":13,"def":15,"spd":11,
	 "flavor":"Routes current to whoever needs it. Every buff an Arcwright grants is paid for in Exposure."},
	{"id":"arc_medic","name":"Arcmend","pillar":CURRENT,"origin_year":1944,"role":"medic",
	...
	{"id":"voltaic_scout","name":"Voltaic Scout","pillar":CURRENT,"origin_year":1944,"role":"infiltrator",
	...
	# ----------------------------------------------------------- CHRONO --
	{"id":"archivist","name":"Farsight","pillar":CHRONO,"origin_year":1944,"role":"analyst",
	...
	{"id":"custodian","name":"Sentinel","pillar":CHRONO,"origin_year":1944,"role":"anchor",
	 "hp":172,"focus":60,"atk":14,"def":21,"spd":9,
	 "flavor":"Keeps a record from being altered by keeping the people near it alive."},
	{"id":"witness","name":"Seer","pillar":CHRONO,"origin_year":1944,"role":"medic",
	...
	{"id":"threshold","name":"Threshold","pillar":PHASE,"origin_year":1944,"role":"anchor",
	...
	{"id":"shadow_medic","name":"Shroudmend","pillar":PHASE,"origin_year":1944,"role":"medic",
	...
	{"id":"rumour","name":"Rumour","pillar":PHASE,"origin_year":1944,"role":"quartermaster",
