...
const ALL := [
	# ---------------------------------------------------------- CURRENT --
	{"id":"anchor_current","name":"The Anchor","pillar":CURRENT,"origin_year":1944,"role":"anchor",
	 "hp":180,"focus":50,"atk":15,"def":22,"spd":9,
	 "flavor":"Holds the line and the current both. Highest guard of any class."},
	{"id":"livewire","name":"Livewire","pillar":CURRENT,"origin_year":1944,"role":"wildcard",
	 "hp":100,"focus":70,"atk":24,"def":9,"spd":15,
	 "flavor":"Trades guard for damage. A Livewire who is caught loud does not get a second warning."},
	{"id":"conduit","name":"Dynamo","pillar":CURRENT,"origin_year":1944,"role":"quartermaster",
	 "hp":130,"focus":85,"atk":13,"def":15,"spd":11,
	 "flavor":"Routes current to whoever needs it. Every buff a Dynamo grants is paid for in Exposure."},
	{"id":"arc_medic","name":"Arclight","pillar":CURRENT,"origin_year":1944,"role":"medic",
	...
	{"id":"groundsman","name":"Earthbreaker","pillar":CURRENT,"origin_year":1944,"role":"anchor",
	...
	{"id":"voltaic_scout","name":"Sparkrunner","pillar":CURRENT,"origin_year":1944,"role":"infiltrator",
	...
	# ----------------------------------------------------------- CHRONO --
	{"id":"archivist","name":"Redact","pillar":CHRONO,"origin_year":1944,"role":"analyst",
	...
	{"id":"forecaster","name":"Foresight","pillar":CHRONO,"origin_year":1944,"role":"analyst",
	...
	{"id":"loop_runner","name":"Paradox","pillar":CHRONO,"origin_year":1944,"role":"wildcard",
	 "hp":108,"focus":80,"atk":20,"def":10,"spd":20,
	 "flavor":"Acts first, always. A closed loop has to start somewhere."},
	{"id":"custodian","name":"The Keeper","pillar":CHRONO,"origin_year":1944,"role":"anchor",
	 "hp":172,"focus":60,"atk":14,"def":21,"spd":9,
	 "flavor":"Keeps a record from being altered by keeping the people near it alive."},
	{"id":"witness","name":"Witness","pillar":CHRONO,"origin_year":1944,"role":"medic",
	...
	# ------------------------------------------------------------ PHASE --
	{"id":"wraith","name":"Wraith","pillar":PHASE,"origin_year":1944,"role":"infiltrator",
	...
	{"id":"threshold","name":"The Threshold","pillar":PHASE,"origin_year":1944,"role":"anchor",
	...
	{"id":"shadow_medic","name":"Umbra","pillar":PHASE,"origin_year":1944,"role":"medic",
	...
	{"id":"rumour","name":"Mirage","pillar":PHASE,"origin_year":1944,"role":"quartermaster",
	...
	{"id":"attenuator","name":"Attenuator","pillar":PHASE,"origin_year":1944,"role":"wildcard",
