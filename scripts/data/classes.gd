...
const ALL := [
	# ---------------------------------------------------------- CURRENT --
	{"id":"anchor_current","name":"Current Warden","pillar":CURRENT,"origin_year":1944,"role":"anchor",
	 "hp":180,"focus":50,"atk":15,"def":22,"spd":9,
	 "flavor":"Holds the line and the current both. Highest guard of any class."},
	{"id":"livewire","name":"Static Grenadier","pillar":CURRENT,"origin_year":1944,"role":"wildcard",
	 "hp":100,"focus":70,"atk":24,"def":9,"spd":15,
	 "flavor":"Trades guard for damage. A Static Grenadier who is caught loud does not get a second warning."},
	{"id":"conduit","name":"Capacitor Corps","pillar":CURRENT,"origin_year":1944,"role":"quartermaster",
	 "hp":130,"focus":85,"atk":13,"def":15,"spd":11,
	 "flavor":"Stores what the fight cannot spend fast enough. Every buff a Capacitor Corps grants is paid for in Exposure."},
	...
	{"id":"groundsman","name":"Grounding Crew","pillar":CURRENT,"origin_year":1944,"role":"anchor",
	...
	{"id":"forecaster","name":"Vector Corporal","pillar":CHRONO,"origin_year":1944,"role":"analyst",
	...
	{"id":"loop_runner","name":"Feedback Loop","pillar":CHRONO,"origin_year":1944,"role":"wildcard",
	...
	# ------------------------------------------------------------ PHASE --
	{"id":"wraith","name":"Phase Runner","pillar":PHASE,"origin_year":1944,"role":"infiltrator",
